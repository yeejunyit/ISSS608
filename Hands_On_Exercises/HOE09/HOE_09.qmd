...
For better visualisation, we make use of [**ggforce**](https://ggforce.data-imaginist.com/) package, which provides missing functionality to **ggplot2**, specifically its `geom_mark_hull()`, which draws a convex hull around groups of points to emphasize the cluster.
