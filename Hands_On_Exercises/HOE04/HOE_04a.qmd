...
We have explored some of the popular statistical graphics methods for visualising distribution e.g. histogram, probability density curve (pdf), boxplot, notch plot and violin plot and how they can be created by using ggplot2 in Hands On Exercise 1.
...
[Ridgeline plot](https://www.data-to-viz.com/graph/ridgeline.html) (also known as *Joyplot*) is a data visualisation technique for revealing the distribution of a numeric value for several groups. Distribution can be represented using histograms or density plots, all aligned to the same horizontal scale and presented with a slight overlap.
